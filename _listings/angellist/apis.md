...
- name: AngelList Delete Comment
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/startups/master/_listings/angellist/comments-comment-id-delete.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/startups/master/_listings/angellist/comments-comment-id-delete-postman.md
x-common:
- type: x-blog
